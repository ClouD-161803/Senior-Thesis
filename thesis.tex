...
\chapter{Optimal transport and triangular maps} \label{ch:optimal_transport}
% \input{sections/3_1_optimal_transport_kr}
% \input{sections/3_2_hermite_basis}
% \input{sections/3_3_physical_structure}
% \input{sections/3_4_constrained_optimisation}
