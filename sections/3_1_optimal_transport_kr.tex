...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \begin{scope}[shift={(0,0)}]
            ...
            \node[particle, fill=red!80] at (-1.4, 2.0) {};
            \node[particle, fill=orange!80] at (-1.0, 1.2) {};
            \node[particle, fill=yellow!80!black] at (-0.6, 0.6) {};
            \node[particle, fill=green!80!black] at (-0.2, -0.2) {};
            \node[particle, fill=cyan!80!black] at (0, -0.5) {};
            \node[particle, fill=blue!80] at (0.2, -0.2) {};
            \node[particle, fill=purple!80] at (0.6, 0.6) {};
            \node[particle, fill=magenta!80] at (1.0, 1.2) {};
            \node[particle, fill=pink!80!black] at (1.4, 2.0) {};
            
            % Label
            \node at (0, -1.6) {Target measure, $p(x)$};
        \end{scope}
        ...
        \draw[->, very thick, color=blue!80] (2.8, 1) to[bend left=10] node[midway, above, text=black] {$S(x)$} (5.2, 1);
        ...
        \begin{scope}[shift={(8,0)}]
            ...
            \node[mapped_particle, fill=red!80] at (-1.2, 0.5) {};
            \node[mapped_particle, fill=orange!80] at (-0.8, -0.2) {};
            \node[mapped_particle, fill=yellow!80!black] at (-0.4, 0.8) {};
            \node[mapped_particle, fill=green!80!black] at (-0.1, -0.6) {};
            \node[mapped_particle, fill=cyan!80!black] at (0, 0.1) {};
            \node[mapped_particle, fill=blue!80] at (0.2, 0.6) {};
            \node[mapped_particle, fill=purple!80] at (0.5, -0.4) {};
            \node[mapped_particle, fill=magenta!80] at (0.9, 0.3) {};
            \node[mapped_particle, fill=pink!80!black] at (1.3, -0.2) {};
            
            % Label
            \node at (0, -3.1) {Reference measure, $\eta(z)$};
        \end{scope}
