...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}
        ...
        \addplot[domain=0:100, samples=200, color=red] {0.1 / (1 + 0*x)};
        \addlegendentry{$\gamma = 0.00$}
        
        \addplot[domain=0:100, samples=200, color=orange] {0.1 / (1 + 0.01*x)};
        \addlegendentry{$\gamma = 0.01$}

        \addplot[domain=0:100, samples=200, color=yellow] {0.1 / (1 + 0.02*x)};
        \addlegendentry{$\gamma = 0.02$}
        
        \addplot[domain=0:100, samples=200, color=green!60!black] {0.1 / (1 + 0.05*x)};
        \addlegendentry{$\gamma = 0.05$}
        
        \addplot[domain=0:100, samples=200, color=blue] {0.1 / (1 + 0.1*x)};
        \addlegendentry{$\gamma = 0.10$}
        
        \addplot[domain=0:100, samples=200, color=violet] {0.1 / (1 + 0.5*x)};
